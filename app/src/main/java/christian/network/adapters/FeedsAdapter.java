...
public class FeedsAdapter extends RecyclerView.Adapter<FeedsAdapter.FeedViewHolder> {
    ...
    public FeedsAdapter(ArrayList<Feed> feeds, Context context, Activity activity) {
        this.feeds = feeds;
...
//        addListeners(holder, position);
    ...
    private void setTimeStamp(TextView tvTime, String date) {
        ...
        Date postDate = ApplicationUtility.formatDate(date, dtFormat);
        String timeStamp = UserNChurchUtils.getPostTime(postDate, currentTimeMs);
